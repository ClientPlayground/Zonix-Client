...
public class WrUpdateThread extends Thread
{
    ...
    public void run()
    {
        ...
        WrUpdateThread.ThreadUpdateListener updateListener = new WrUpdateThread.ThreadUpdateListener((WrUpdateThread.NamelessClass1621800805)null);
    ...
    private class ThreadUpdateControl implements IWrUpdateControl
    {
        ...
        ThreadUpdateControl(WrUpdateThread.NamelessClass1621800805 x1)
        {
            this();
        }
    }
    ...
    private class ThreadUpdateListener implements IWrUpdateListener
    {
        ...
        {
            this.tuc = WrUpdateThread.this.new ThreadUpdateControl((WrUpdateThread.NamelessClass1621800805)null);
        }
        ...
        ThreadUpdateListener(WrUpdateThread.NamelessClass1621800805 x1)
        {
            this();
        }
    }
