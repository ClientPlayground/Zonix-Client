...
public abstract class EntityLivingBase extends Entity {
	private static final UUID sprintingSpeedBoostModifierUUID = UUID.fromString
	...
	protected void updateFallState(double p_70064_1_, boolean p_70064_3_) {
		...
		if (p_70064_3_ && this.fallDistance > 0.0F) {
			...
			if (var7.getMaterial() == Material.air) {
				...
				this.worldObj
						.playAuxSFX(2006, var4, var5, var6, MathHelper.ceiling_float_int(this.fallDistance - 3.0F));
			}
	...
	protected void onNewPotionEffect(PotionEffect p_70670_1_) {
		...
		if (!this.worldObj.isClient) {
			Potion.potionTypes[p_70670_1_.getPotionID()]
					.applyAttributesModifiersToEntity(this, this.getAttributeMap(), p_70670_1_.getAmplifier());
		}
	}
	...
	protected void onChangedPotionEffect(PotionEffect p_70695_1_, boolean p_70695_2_) {
		...
		if (p_70695_2_ && !this.worldObj.isClient) {
			Potion.potionTypes[p_70695_1_.getPotionID()]
					.removeAttributesModifiersFromEntity(this, this.getAttributeMap(), p_70695_1_.getAmplifier());
			Potion.potionTypes[p_70695_1_.getPotionID()]
					.applyAttributesModifiersToEntity(this, this.getAttributeMap(), p_70695_1_.getAmplifier());
		}
	}
	...
	protected void onFinishedPotionEffect(PotionEffect p_70688_1_) {
		...
		if (!this.worldObj.isClient) {
			Potion.potionTypes[p_70688_1_.getPotionID()]
					.removeAttributesModifiersFromEntity(this, this.getAttributeMap(), p_70688_1_.getAmplifier());
		}
	}
			...
			if (this.getHealth() <= 0.0F) {
				...
				if (var3) {
					...
					if (var4 != null) {
						...
						for (var7 = var4.posZ - this.posZ; var9 * var9 + var7 * var7 < 1.0E-4D;
	...
	public void renderBrokenItemStack(ItemStack p_70669_1_) {
		...
		for (int var2 = 0; var2 < 5; ++var2) {
			Vec3 var3 = Vec3
					.createVectorHelper(((double) this.rand.nextFloat() - 0.5D) * 0.1D, Math.random() * 0.1D + 0.1D,
							0.0D);
			...
			this.worldObj
					.spawnParticle("iconcrack_" + Item.getIdFromItem(p_70669_1_.getItem()), var4.xCoord, var4.yCoord,
	...
	public void setPositionAndUpdate(double p_70634_1_, double p_70634_3_, double p_70634_5_) {
		...
		NativeUtil.a(p_70634_1_, p_70634_3_, p_70634_5_);
	}
				...
				if (var10 != 0 || var11 != 0) {
					...
					if (this.worldObj.func_147461_a(var2).isEmpty()) {
						...
						if (World.doesBlockHaveSolidTopSurface(this.worldObj, var12, (int) this.posY - 1, var13) ||
						    this.worldObj.getBlock(var12, (int) this.posY - 1, var13).getMaterial() == Material
                                    .water) {
	...
	public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_) {
		...
		if (this.isInWater() && (!(this instanceof EntityPlayer) || !((EntityPlayer) this).capabilities.isFlying)) {
			...
			if (this.isCollidedHorizontally &&
			    this.isOffsetPositionInLiquid(this.motionX, this.motionY + 0.6000000238418579D - this.posY + var8,
					    this.motionZ)) {
			...
			for (int var2 = 0; var2 < 5; ++var2) {
				...
				if (!ItemStack.areItemStacksEqual(var4, var3)) {
					((WorldServer) this.worldObj).getEntityTracker()
							.func_151247_a(this, new S04PacketEntityEquipment(this.getEntityId(), var2, var4));
