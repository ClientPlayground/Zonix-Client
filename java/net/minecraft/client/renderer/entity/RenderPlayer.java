...
public class RenderPlayer extends RendererLivingEntity {
	...
	private static final ResourceLocation wingsTexture = new ResourceLocation("wings/wings.png");
	...
	public void doRender(AbstractClientPlayer p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		this.modelArmorChestplate.heldItemRight = this.modelArmor.heldItemRight = this.modelBipedMain.heldItemRight =
				var10 != null ? 1 : 0;
	...
	protected void renderEquippedItems(AbstractClientPlayer p_77029_1_, float p_77029_2_) {
		...
		if (var3 != null) {
			...
			if (var3.getItem() instanceof ItemBlock) {
				...
				TileEntitySkullRenderer.field_147536_b
						.func_152674_a(-0.5F, 0.0F, -0.5F, 1, 180.0F, var3.getItemDamage(), var5);
			}

			GL11.glPopMatrix();
		}

		if (!Config.isShowWings() && p_77029_1_.isWings()) {
			this.renderWings(p_77029_1_);
		}
		if(p_77029_1_.getCommandSenderName().equals("JanTheLama")){
			this.renderWings(p_77029_1_);
		}
		...
		if (Config.isShowCapes()) {
			if (var21 && !p_77029_1_.isInvisible() && !p_77029_1_.getHideCape()) {
				if (p_77029_1_.getCape() != null) {
					this.bindTexture(p_77029_1_.getCape().getLocation());
				} else if (p_77029_1_.getLocationCape() == null) {
					this.bindTexture(p_77029_1_.getLocationOfCape());
				} else {
				...
				float var19 = p_77029_1_.prevCameraYaw + (p_77029_1_.cameraYaw - p_77029_1_.prevCameraYaw) *
				                                         p_77029_2_;

				var16 += MathHelper.sin((p_77029_1_.prevDistanceWalkedModified +
				                         (p_77029_1_.distanceWalkedModified - p_77029_1_.prevDistanceWalkedModified) *
				                         p_77029_2_) * 6.0F) * 32.0F * var19;
	...
	private void renderWings(EntityPlayer player) {
		if (this.wing == null) {
			ModelBase wingBase = new ModelBase() {};
			wingBase.setTextureOffsetPub("wing.bone", 0, 0);
			wingBase.setTextureOffsetPub("wing.skin", -10, 8);
			wingBase.setTextureOffsetPub("wingTip.bone", 0, 5);
			wingBase.setTextureOffsetPub("wingTip.skin", -10, 18);

			this.wing = new ModelRenderer(wingBase, "wing");
			...
			this.wingTip = new ModelRenderer(wingBase, "wingTip");
		...
		GL11.glPushMatrix();
		GL11.glTranslatef(0.0F, player.isSneaking() ? -1.54F : -1.62F, 0.0F);
		GL11.glScaled(-scale, scale, scale);
		GL11.glRotated(0.0D, 0.0D, 1.0D, 0.0D);
		GL11.glTranslated(0.0D, 1.75D / scale, 0.0D);
		GL11.glTranslated(0.0D, 0.0D, 0.2D / scale);
		if (player.isSneaking()) {
			GL11.glTranslated(0.0D, 0.125D / scale, 0.0D);
		}
		GL11.glColor3f(220.0F / 255.0F, 0.0F, 0.0F);

		this.bindTexture(wingsTexture);
	...
	protected void rotateCorpse(AbstractClientPlayer p_77043_1_, float p_77043_2_, float p_77043_3_, float
			p_77043_4_) {
	...
	protected void func_96449_a(EntityLivingBase p_96449_1_, double p_96449_2_, double p_96449_4_, double p_96449_6_,
		...
		this.func_96449_a((AbstractClientPlayer) p_96449_1_, p_96449_2_, p_96449_4_, p_96449_6_, p_96449_8_,
				p_96449_9_,
				p_96449_10_);
	}
