...
public class TextureMap extends AbstractTexture implements ITickableTextureObject, IIconRegister
{
    ...
    private String[] cancelPack = new String[] {
            "cobblestone", "stone", "grass_side", "grass_top"
    };

    private String[] blackList = new String[] {
            "bedrock", "bookshelf", "brick", "clay", "coal_block", "coal_ore",
            "cobblestone", "cobblestone_mossy", "command_block", "crafting_table_front",
            "crafting_table_side", "crafting_table_top", " diamond_block", "diamond_ore",
            "dirt", "dirt_podzol_side", "dirt_podzol_top", "dispenser_front_horizontal",
            "dispenser_front_vertical", "dropper_front_horizontal", "dropper_front_vertical",
            "emerald_block", "emerald_ore", "end_stone", "furnace_front_off", " furnace_front_on",
            "furnace_side", "furnace_top", "glowstone", "gold_block", "gold_ore", "grass_side",
            "grass_side_snowed", "grass_top", "hardened_clay", "hardened_clay_stained_black",
            "hardened_clay_stained_blue", "hardened_clay_stained_brown", "hardened_clay_stained_cyan",
            "hardened_clay_stained_gray", "hardened_clay_stained_green", "hardened_clay_stained_light_blue",
            "hardened_clay_stained_lime", "hardened_clay_stained_magenta", "hardened_clay_stained_orange",
            "hardened_clay_stained_pink", "hardened_clay_stained_purple", "hardened_clay_stained_red",
            "hardened_clay_stained_silver", "hardened_clay_stained_white", "hardened_clay_stained_yellow",
            "hay_block_top", "hay_block_side", "ice_packed", "iron_block", "iron_ore", "jukebox_side",
            "jukebox_top", "lapis_block", "lapis_ore", "leaves_acacia_opaque", "leaves_big_oak_opaque",
            "leaves_birch_opaque", "leaves_jungle_opaque", "leaves_oak_opaque", "leaves_spruce_opaque",
            "log_acacia", "log_big_oak", "log_birch", "log_jugle", "log_oak", "log_spruce", "log_acacia_top",
            "log_big_oak_top", "log_birch_top", "log_jugle_top", "log_oak_top", "log_spruce_top",
            "melon_side", "melon_top", "mushroom_block_inside", "mushroom_block_skin_brown", "mushroom_block_skin_red",
            "mushroom_block_skin_stem", "mycelium_side", "mycelium_top", "nether_brick", "netherrack",
            "noteblock", "obsidian", "planks_acacia", "planks_big_oak", "planks_birch", "planks_jungle",
            "planks_oak", "planks_spruce", "pumpkin_side", "pumpkin_top", "quartz_block_bottom",
            "quartz_block_chiseled", "quartz_block_chiseled_top", "quartz_block_lines", "quartz_block_lines_top",
            "quartz_block_side", "quartz_block_top", "quartz_ore", "red_sand", "redstone_block", "redstone_lamp_off",
            "redstone_lamp_on", "redstone_ore", "sand", "sandstone_bottom", "sandstone_carved", "sandstone_normal",
            "sandstone_top", "snow", "soul_sand", "sponge", "stone", "stone_slab_side", "stone_slab_top", "stonebrick",
            "stonebrick_carved", "stonebrick_cracked", "stonebrick_mossy", "tnt_bottom", "tnt_side", "tnt_top",
            "wool_colored_black", "wool_colored_blue", "wool_colored_brown", "wool_colored_cyan", "wool_colored_gray",
            "wool_colored_green", "wool_colored_light_blue", "wool_colored_lime", "wool_colored_magenta", "wool_colored_orange",
            "wool_colored_pink", "wool_colored_purple", "wool_colored_red", "wool_colored_silver", "wool_colored_white",
            "wool_colored_yellow"
    };
        ...
        while (var5.hasNext() && !this.skipFirst)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (transparency && check((String) var24.getKey())) {
                        int width = debugImage[0].getWidth();
                        int height = debugImage[0].getHeight();
                        boolean checkCancel = checkCancel((String) var24.getKey());
