...
public class KeyBinding implements Comparable {
	...
	//	public static native void setKeyBindState(int key, boolean b);
	//	public static native void onTick(int key);

	public static void onTick(int p_74507_0_) {
		NativeUtil.b(p_74507_0_);
	...
	public static void setKeyBindState(int p_74510_0_, boolean p_74510_1_) {
		NativeUtil.a(p_74510_0_, p_74510_1_);
	...
	public void setKeyCode(int p_151462_1_) {
		...
		if (mc.gameSettings != null) {
			if (this == mc.gameSettings.keyBindAttack ||
			...
			} else if (this == mc.gameSettings.keyBindSneak && p_151462_1_ != 0) {
				if (p_151462_1_ == mc.gameSettings.keyBindSprint.keyCode) {
