...
public class ServerList {
	 ...
	 */
	public final List<ServerData> servers = new ArrayList<>();
	...
	public final List<ServerData> pinnedServers = Arrays.asList(
			new ServerData("Zonix US", "zonix.us", 0xA9983C3C),
			new ServerData("Zonix EU", "eu.zonix.us", 0xA93C985C),
			new ServerData("Zonix SA", "sa.zonix.us", 0xA93C6798),
			new ServerData("Zonix AS", "as.zonix.us", 0xA9983C97)
	);

	/**
	 * Loads a list of servers from servers.dat, by running ServerData.getServerDataFromNBTCompound on each NBT
     * compound
