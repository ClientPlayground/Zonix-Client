...
public class Main {
	...
	public static class MCAuthenticator extends Authenticator {
		...
		public MCAuthenticator(String var25, String var26) {
			this.var25 = var25;
			this.var26 = var26;
		}
	...
	public static class MCSShutdownHook extends Thread {
		...
		public MCSShutdownHook(String msg) {
			super(msg);
		}
	...
	private static final java.lang.reflect.Type field_152370_a = new MCType();
	private static final String __OBFID = "CL_00001461";

	// Look at monitor 2 and look at github feed...
	// PRESTIGE PVP
	...
	public static void main(String[] p_main_0_) {
		...
		ArgumentAcceptingOptionSpec var8 = var1.accepts("proxyPort").withRequiredArg().defaultsTo("8080", new
				String[0])
		...
		ArgumentAcceptingOptionSpec var19 = var1.accepts("userType").withRequiredArg()
		...
		Session var38 = new Session((String) var11.value(var21), var36, (String) var13.value(var21),
				(String) var19.value(var21));
		Minecraft var39 = new Minecraft(var38, var27, var28, var29, var30, var42, var43, var35, var24, var31, var32,
				var37);
