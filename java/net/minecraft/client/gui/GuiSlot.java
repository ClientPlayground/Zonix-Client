...
public abstract class GuiSlot {
	...
	public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_) {
		...
		if (p_148128_1_ > this.field_148152_e && p_148128_1_ < this.field_148151_d &&
		    p_148128_2_ > this.field_148153_b && p_148128_2_ < this.field_148154_c) {
			if (Mouse.isButtonDown(0) && this.func_148125_i()) {
				if (this.field_148157_o == -1.0F) {
					...
					if (p_148128_2_ >= this.field_148153_b && p_148128_2_ <= this.field_148154_c) {
						...
						var10 = p_148128_2_ - this.field_148153_b - this.field_148160_j + (int) this.field_148169_q
                                - 4;
				...
				for (; !this.field_148161_k.gameSettings.touchscreen && Mouse.next();
