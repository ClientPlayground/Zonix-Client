...
public class GuiNewChat extends Gui {
						...
						if (var11 < 200 || var3) {
							...
							if (var14 > 3) {
								...
								if (!FPSBoost.CHAT_SHADOW.getValue()) {
									this.field_146247_f.fontRenderer
											.drawString(var17, var15, var16 - 8, 16777215 + (var14 << 24));
								} else {
									this.field_146247_f.fontRenderer
											.drawStringWithShadow(var17, var15, var16 - 8, 16777215 + (var14 << 24));
								}
	...
	private void func_146237_a(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_) {
		...
		for (Iterator var21 = var8.iterator(); var21.hasNext();
					...
					if (var9 >= 0 && var9 < this.field_146253_i.size()) {
						...
						while (var12.hasNext()) {
							...
							if (var13 instanceof ChatComponentText) {
								var11 += this.field_146247_f.fontRenderer.getStringWidth(this.func_146235_b(
										((ChatComponentText) var13).getChatComponentText_TextValue()));
