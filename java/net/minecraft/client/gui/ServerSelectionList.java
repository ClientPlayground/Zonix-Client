...
public class ServerSelectionList extends GuiListExtended {
	...
	public void close() {
		//		for (Object o : field_148198_l) {
		//			if (o instanceof ServerListEntryPinned) {
		//				((ServerListEntryPinned) o).running = false;
		//			} else if (o instanceof ServerListEntryNormal) {
		//				((ServerListEntryNormal) o).running = false;
		//			}
		//		}
	}
	...
	public void func_148195_a(ServerList p_148195_1_) {
		...
		//
		//		for (ServerData pinnedServer : p_148195_1_.pinnedServers) {
		//			this.field_148198_l.add(new ServerListEntryPinned(this.field_148200_k, pinnedServer));
		//		}
		//
		//		for (int var2 = 0; var2 < p_148195_1_.countServers(); ++var2) {
		//			ServerData serverData = p_148195_1_.getServerData(var2);
		//			if (!p_148195_1_.pinnedServers.contains(serverData)) {
