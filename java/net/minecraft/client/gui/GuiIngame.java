...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_) {
		...
		if (this.mc.isDemo()) {
			...
			if (this.mc.theWorld.getTotalWorldTime() >= 120500L) {
				...
				var35 = I18n.format("demo.remainingTime", new Object[]{StringUtils.ticksToElapsedTime(
		...
		if (this.mc.gameSettings.showDebugInfo) {
			...
			this.drawString(var8, String.format("x: %.5f (%d) // c: %d (%d)",
					new Object[]{Double.valueOf(this.mc.thePlayer.posX),
					             Integer.valueOf(var22),
					             Integer.valueOf(var22 >> 4),
					             Integer.valueOf(var22 & 15)}), 2, 64, 14737632);
			this.drawString(var8, String.format("y: %.3f (feet pos, %.3f eyes pos)",
					new Object[]{Double.valueOf(this.mc.thePlayer.boundingBox.minY),
					             Double.valueOf(this.mc.thePlayer.posY)}), 2, 72, 14737632);
			this.drawString(var8, String.format("z: %.5f (%d) // c: %d (%d)",
					new Object[]{Double.valueOf(this.mc.thePlayer.posZ),
					             Integer.valueOf(var24),
					             Integer.valueOf(var24 >> 4),
					             Integer.valueOf(var24 & 15)}), 2, 80, 14737632);
			...
			if (this.mc.theWorld != null && this.mc.theWorld.blockExists(var22, var23, var24)) {
				...
				this.drawString(var8, "lc: " + (var26.getTopFilledSegment() + 15) + " b: " +
				                      var26.getBiomeGenForWorldCoords(var22 & 15, var24 & 15,
						                      this.mc.theWorld.getWorldChunkManager()).biomeName + " bl: " +
				                      ...
				                      " rl: " + var26.getBlockLightValue(var22 & 15, var23, var24 & 15, 0), 2, 96,
						14737632);
			}

			this.drawString(var8, String.format("ws: %.3f, fs: %.3f, g: %b, fl: %d",
					new Object[]{Float.valueOf(this.mc.thePlayer.capabilities.getWalkSpeed()),
					             ...
					             Integer.valueOf(this.mc.theWorld.getHeightValue(var22, var24))}), 2, 104, 14737632);

			if (this.mc.entityRenderer != null && this.mc.entityRenderer.isShaderActive()) {
				this.drawString(var8, String.format("shader: %s",
						new Object[]{this.mc.entityRenderer.getShaderGroup().getShaderGroupName()}), 2, 112, 14737632);
			}
		...
		us.zonix.client.module.impl.Scoreboard scoreboard =
				Client.getInstance().getModuleManager().getModule("Scoreboard");
		if (scoreboard.isEnabled() && !(this.mc.currentScreen instanceof GuiIngameMenu)) {
			scoreboard.render(var37, var7, var6, var8);
		}
		...
		if (this.mc.gameSettings.keyBindPlayerList.getIsKeyPressed() &&
		    (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.playerInfoList.size() > 1 ||
		     var37 != null)) {
	...
	private void func_96136_a(ScoreObjective p_96136_1_, int p_96136_2_, int p_96136_3_, FontRenderer p_96136_4_) {
		...
		if (var6.size() <= 15) {
			...
			for (Iterator var8 = var6.iterator(); var8.hasNext();
				...
				String suffix = ": " + EnumChatFormatting.RED +
				                var9.getScorePoints();
				var11 = prefix + suffix;
			}
	...
	private void renderInventorySlot(int p_73832_1_, int p_73832_2_, int p_73832_3_, float p_73832_4_) {
		...
		if (var5 != null) {
			...
			itemRenderer.renderItemAndEffectIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), var5,
					p_73832_2_,
					p_73832_3_);
