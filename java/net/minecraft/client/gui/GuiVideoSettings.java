    ...
    public void initGui() {
        ...
        for (var15 = 0; var15 < var14; ++var15) {
            ...
            if (y != null) {
                ...
                int y1 = this.height / 6 + 25 * (var15 / 2) - 10;
        ...
        int var16 = this.height / 6 + 25 * (var15 / 2) - 10;
        ...
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, var16 + 25, I18n.format("gui.done", new Object[0])));
    }

    protected void actionPerformed(GuiButton par1GuiButton) {
        if (par1GuiButton.enabled) {/*
            if (par1GuiButton.id == GameSettings.Options.CHUNK_LOADING.ordinal()) {
                return;
            }*/
...
//        }
    ...
    private String[] getTooltipLines(String btnName) {
        return btnName.equals("Graphics") ? new String[]{
                "Visual quality",
        ...
        } : (btnName.equals("View Bobbing") ? new String[]{
                "More realistic movement.",
                "When using mipmaps set it to OFF for best results."
        } : (btnName.equals("GUI Scale") ? new String[]{
        ...
        } : (btnName.equals("Advanced OpenGL") ? new String[]{
                ...
                "graphic card."
        } : (btnName.equals("Fog Start") ? new String[]{
                "Fog start",
        ...
        } : (btnName.equals("Brightness") ? new String[]{
                ...
                "fully black objects"
        } : (btnName.equals("Chunk Loading") ? new String[]{
                "Chunk Loading",
                ...
                "",
                "Currently you can only use 'Smooth' chunk loading."
        } : null))))))))))));
    }
