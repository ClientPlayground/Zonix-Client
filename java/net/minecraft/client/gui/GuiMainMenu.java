...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	public void initGui() {
		...
		this.field_110351_G = this.mc.getTextureManager().getDynamicTextureLocation("background", this
				.viewportTexture);
	...
	private void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_) {
		...
		var4.addVertexWithUV(0.0D, (double) var9, (double) this.zLevel, (double) (0.5F - var6), (double) (0.5F +
		                                                                                                  var7));
		var4.addVertexWithUV((double) var8, (double) var9, (double) this.zLevel, (double) (0.5F - var6),
				(double) (0.5F - var7));
		var4.addVertexWithUV((double) var8, 0.0D, (double) this.zLevel, (double) (0.5F + var6), (double) (0.5F -
		                                                                                                  var7));
