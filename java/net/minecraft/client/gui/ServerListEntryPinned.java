...
public class ServerListEntryPinned implements GuiListExtended.IGuiListEntry
{
    ...
    private static final ResourceLocation pinnedIcon = new ResourceLocation("icon/pin.png");
    ...
    protected ServerListEntryPinned(GuiMultiplayer p_i45048_1_, ServerData p_i45048_2_)
    {
        ...
        if (!this.field_148301_e.field_78841_f)
        {
            ...
            field_148302_b.submit(new Runnable() {
                @Override public void run() {
                    try {
                        ServerListEntryPinned.this.field_148303_c.func_146789_i()
                                .init(ServerListEntryPinned.this.field_148301_e);
                    } catch (UnknownHostException var2) {
                        ServerListEntryPinned.this.field_148301_e.pingToServer = -1L;
                        ServerListEntryPinned.this.field_148301_e.serverMOTD = EnumChatFormatting.DARK_RED +
                    ...
                    while (running) {
                        try {
                            ServerListEntryPinned.this.field_148303_c.func_146789_i()
                                    .func_147224_a(ServerListEntryPinned.this.field_148301_e, null, null);
                        } catch (UnknownHostException var2) {
                            ServerListEntryPinned.this.field_148301_e.pingToServer = -1L;
                            ServerListEntryPinned.this.field_148301_e.serverMOTD = EnumChatFormatting.DARK_RED +
                                                                                   "Can\'t resolve hostname";
...
//        GL11.glPushMatrix();
//        {
//            GL11.glColor4f(0.87F, 0.2F, 0.1F, 1.0F);
            RenderUtil.drawSquareTexture(pinnedIcon, 8, p_148279_2_ - 32, p_148279_3_ + 1);
//        }
//        GL11.glPopMatrix();
        ...
        List var13 = this.mc.fontRenderer.listFormattedStringToWidth(this.field_148301_e.serverMOTD, p_148279_4_ - 32 - 2);

        for (int var14 = 0; var14 < Math.min(var13.size(), 2); ++var14)
        {
            this.mc.fontRenderer.drawString((String)var13.get(var14), p_148279_2_ + 32 + 3, p_148279_3_ + 12 + this.mc.fontRenderer.FONT_HEIGHT * var14, 8421504);
        }
