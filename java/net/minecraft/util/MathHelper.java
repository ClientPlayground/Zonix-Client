...
public class MathHelper {
	...
	/**
	 * Though it looks like an array, this is really more like a mapping.  Key (index of this array) is the upper 5
     * bits
	...
	public static final float sin(float par0) {
		return fastMath ?
				SIN_TABLE_FAST[(int) (par0 * 651.8986F) & 4095] :
	...
	public static final float cos(float par0) {
		return fastMath ?
				SIN_TABLE_FAST[(int) ((par0 + ((float) Math.PI / 2F)) * 651.8986F) & 4095] :
	...
	/**
	 * Returns the value of the first parameter, clamped to be within the lower and upper limits given by the second
     * and
	 * third parameters.
	 */
	...
	static {
		...
		multiplyDeBruijnBitPosition = new int[]{0,
		                                        1,
		                                        28,
		                                        2,
		                                        29,
